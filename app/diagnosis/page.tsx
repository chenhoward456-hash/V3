            ...
            <div className="space-y-6">
              ...
              {/* TDEE 顯示 */}
                  ...
                  {!emailSent ? (
                    ...
                    <div className="bg-emerald-50 border border-emerald-200 rounded-2xl px-4 py-3 text-sm text-emerald-800 text-center">
                      ✅ 完整報告已寄出，記得收信
                    </div>
                  )}
