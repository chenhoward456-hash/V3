...
const hardcodedPosts = [
  {
    id: '39',
    title: '一週三練怎麼排？推、拉、全身——完整課表、組數與部位總量對照表',
    description: '一週五練對多數人不成立，因為前提是你每週真的到五次。推／拉／全身讓每個部位一週自動吃到兩次刺激（統合分析：量相等時兩次勝過一次）。附完整三天課表、每個動作組數次數、一週部位總量對照表，以及腿為什麼不能低於 4 組。',
    date: '2026-08-14',
    category: '訓練恢復',
    readTime: '8 分鐘',
    slug: 'three-day-split-guide-2026',
  },
  {
    id: '38',
