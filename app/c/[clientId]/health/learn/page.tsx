...
const FAQS: FaqItem[] = [
  ...
  // 補品策略
  {
    ...
    // 稽核 P-10：原文「高三酸甘油酯者 4 g/日 處方級劑量」＋處方藥療效數字 = 對特定病症給劑量建議，越界。
    // 改成一般保健用量 + 追蹤語氣；更高劑量明說屬醫療處置、交給醫師。
    a: '一般保健常見的用量是 EPA+DHA 合計 1-2 g/日——看標示上的「EPA+DHA 含量」，不是魚油總重。超過 2 g/日屬於醫療處置的範圍，要不要吃、吃多少請跟醫師討論，不要自己往上加。我們能幫你做的是追蹤：三酸甘油酯、ApoB 這些血檢數字隨時間怎麼變，讓你和醫師討論時有依據。魚油 vs 藻油：藻油為原始來源、不含重金屬、適合素食者；魚油較便宜。',
  },
  {
    cat: '補品策略',
