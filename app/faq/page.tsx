  ...
  const faqs = [
    ...
    },
    {
      ...
      questions: [
        {
          q: '有哪些方案？費用怎麼算？',
          a: '目前有三種方案：免費體驗（$0，體重追蹤 + 飲食紀錄 + TDEE 計算）、自主管理版（NT$499/月，限時優惠首月 NT$399，智能引擎完整存取）、教練指導版（NT$2,999/月，系統 + CSCS 教練每週 review）。全部月繳制，隨時可取消。'
        },
        {
          q: '可以先免費試用嗎？',
        ...
        {
          q: '如果中途想暫停或取消怎麼辦？',
          a: '月繳制，隨時可取消，不綁約。首次付款 7 日內可全額退費（詳見退費政策）；之後當月不退費，下個月停止扣款。自主管理版可隨時升級教練指導版，補差額即可。'
        }
      ]
    }
  ]
