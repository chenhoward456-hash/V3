...
const MALE_ZONES: BodyFatZone[] = [
  // ─── ZONE 1: Competition Lean (<8%) ───
  {
    ...
    notes: [
      ...
      'Post-competition: return to maintenance in week 1 — do NOT reverse diet slowly. Recovery is driven by restored body mass and energy availability, not by a slow calorie ramp (Lima 2022, PMID 35966021). See lib/recovery-diet.ts.',
...
const FEMALE_ZONES: BodyFatZone[] = [
  // ─── ZONE 1: Competition Lean (<15%) ───
  {
    ...
    notes: [
      ...
      'Post-competition: return to maintenance immediately — a slow reverse diet prolongs fat restoration and may slow recovery (Lima 2022, PMID 35966021). Menstrual recovery can take up to 71 weeks. See lib/recovery-diet.ts.',
