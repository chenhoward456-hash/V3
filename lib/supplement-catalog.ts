...
export const SUPPLEMENT_CATALOG: SupplementSuggestion[] = [
  // ── 心血管 / 血脂 ──
  {
    ...
    dosage: '2-3 g/日',
    timing: '早餐',
    rationaleStarter: '文獻顯示對三酸甘油酯、發炎指標與心血管風險指標（ApoB、hsCRP）有支持。',
  ...
  },
  {
    ...
    timing: '晚餐',
    rationaleStarter: '柑橘類黃酮，文獻顯示與 LDL-C、ApoB 的變化相關。',
  ...
  },
  {
    ...
    dosage: '300-600 mg/日',
    timing: '早餐',
    rationaleStarter: '抗氧化；文獻顯示對血糖相關指標有支持。空腹服用吸收較好。',
  ...
  },
  {
    ...
    dosage: '400-500 mg/日',
    timing: '睡前',
    rationaleStarter: '甘氨酸鎂吸收佳、不易腹瀉。文獻顯示對睡眠、肌肉放鬆、血糖相關指標有支持。',
  ...
  },
  {
    ...
    dosage: '15-30 mg/日',
    timing: '晚餐',
    rationaleStarter: '文獻顯示與免疫、男性荷爾蒙合成、芳香化酶活性相關。長期高劑量需搭配銅。',
  ...
  },
  {
    ...
    timing: '早餐',
    rationaleStarter: '甲基化形式對 MTHFR 變異者較好吸收；文獻顯示與同半胱胺酸下降相關。',
